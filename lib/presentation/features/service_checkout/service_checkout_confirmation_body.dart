...
class ServiceCheckoutConfirmationBody extends ConsumerWidget {
  final Map<String, dynamic> data;
  const ServiceCheckoutConfirmationBody({super.key, required this.data});
  @override
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ref.watch(ispaymentServiceDone)!
                    ...
                    ref.watch(ispaymentServiceDone)!
                        ? SizedBox(
                            ...
                            child: ElevatedButton(
                              onPressed: () {
                                context.go('/service/checkout/status',
                                    extra: data);
                              },
                            ...
                            child: ElevatedButton(
                              onPressed: () {
                                ref
                                    ...
                                    .initServicePayment(
                                        ref.read(paymentServiceRequestprovider),
                                        context);
                              },
